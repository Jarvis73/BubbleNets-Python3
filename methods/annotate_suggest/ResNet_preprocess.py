...
from methods.annotate_suggest.ResNet import inception_preprocessing
from methods.annotate_suggest.ResNet import resnet_v2
...
def resnet_process_data_dir(raw_data_dir):
    ...
    for _, video_name in enumerate(video_list):
        ...
        if not os.path.isfile(pickle_out):
            ...
            pickle.dump(pickle_data, open(pickle_out, 'wb'), pickle.HIGHEST_PROTOCOL)
